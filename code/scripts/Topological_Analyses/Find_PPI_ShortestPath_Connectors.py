...
def main():
    ...
    GI_PPI_optimal_module_overlap_DF = import_module_overlap_table(main_path,
        file_path = "results/Topological_Analyses/GI_PPI_optimal_module_overlap_clean.csv")
    ...
    file_path = "results/IntermediateFiles/PPI_pairwise_module_shortest_paths_dict.pickle"
