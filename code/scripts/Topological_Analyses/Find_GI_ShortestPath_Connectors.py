...
def find_GI_SP_connectors(GI_APSP_dict, GI_module_dict, GI_module_arr):
    ...
    for pair in tqdm(GI_Module_ORFs_pairwise_comb):
...
def main():
    ...
    ## Import LookUp Table
    file_path = "results/IntermediateFiles/encode_LUT_dict.pickle"
    ...
    GI_negEpsi_network_G = import_GI_network(main_path, 
        file_path = "results/Stoichiometry_and_GI/costanzo_2016_longer_withoutReps.csv",
    ...
    GI_module_dict = sort_GI_ORFs(
        main_path,
        file_path = "../data/Modules/Costanzo2016_DataFileS6.xlsx",
    ...
    file_path = "results/IntermediateFiles/GI_pairwise_module_shortest_paths_dict.pickle"
