...
Yeast_PPI_Network_DF <-
  read.csv("../data/Mass_Spectrometry_Interactomes/The_Yeast_Interactome_Edges.csv",
           sep = ";")
...
write.csv(Complex_PPI_network, "../results/Topological_Analyses/Yeast_PPI_Network_CPX.csv")
