...
# Export human stoichiometry data. 
# Combines both Hein et al. (Cell, 2015) and Cho et al. (Science, 2022) datasets
write.csv(Human_Stoich_PPI_DF, "../results/Stoichiometry_and_GI/Human_Interactome_Stoich.csv")
...
## Export human Stoichiometry data merged with GI data
write.csv(Human_Stoich_GI_DF, "../results/Stoichiometry_and_GI/Human_Stoich_GI.csv")
...
## Export results for later use in figures
write.csv(Human_Stoich_GI_DF, "../results/Stoichiometry_and_GI/Human_Stoich_GI_wRegions.csv")
