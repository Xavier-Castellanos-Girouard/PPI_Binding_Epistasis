...
output_folder = '../results/Stoichiometry_and_GI/'


source_folder = data_folder
datasets = ['NxN','ExE','ExN_NxE']

print("*** Preprocessing Yeast GI files ***")

#### Load all 3 datasets ####

print("Importing raw GI scores...")
...
# Remove strain IDs
costanzo_2016_longer['ORF_query'] = costanzo_2016_longer['strain_id_query'].str.replace("_.*", "", regex=True)
costanzo_2016_longer['strain_query'] = costanzo_2016_longer['strain_id_query'].str.replace(".*_", "", regex=True)

costanzo_2016_longer['ORF_array'] = costanzo_2016_longer['strain_id_array'].str.replace("_.*", "", regex=True)
costanzo_2016_longer['strain_array'] = costanzo_2016_longer['strain_id_array'].str.replace(".*_", "", regex=True)
...
print("Removing duplicated ORFs by keeping lowest p-val...")
