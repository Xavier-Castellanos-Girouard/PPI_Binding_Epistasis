...
#### Main ####
CDTlist <- readCDT(paste0(dir, "R_GI_Network_Reconstruction/results/Kd_inferred_GI.cdt"))
...
write.csv(CDT_DF, paste0(dir, "R_GI_Network_Reconstruction/results/Clustered_Kd_inferred_GI.csv"))
