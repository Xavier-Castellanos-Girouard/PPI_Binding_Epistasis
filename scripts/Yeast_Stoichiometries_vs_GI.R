...
Stoich_PPI_Network <- read.csv(paste0(dir, "R_Calc_Stoichiometries/results/Yeast_Interactome_Stoich.csv"), row.names = 1)
...
# Export
#write.csv(Stoich_GI_Network_DT, "../results/Yeast_Stoich_GI.csv")
...
write.csv(Stoich_GI_Network_DF, paste0(dir, "R_Stoichiometries_vs_GI/results/Yeast_Stoich_GI_wRegions.csv"))
