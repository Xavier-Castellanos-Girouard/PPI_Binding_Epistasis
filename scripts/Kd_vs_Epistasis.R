...
GI_Network_DF <- read.csv(paste0(dir, "Python_GI_Network_Formatting/data/Costanzo_GI_processed/costanzo_2016_longer_withoutReps.csv"))
row.names(GI_Network_DF) <- NULL

# Import Yeast Kd values
Kd_PPI_Network_DF <- read.csv(paste0(dir, "R_Calc_Kd_Benchmark/results/Yeast_Estimated_Kd.csv"),
                                  row.names = 1)
row.names(Kd_PPI_Network_DF) <- NULL

# Import Human Kd values
Human_Kd_PPI_Network_DF <- read.csv(paste0(dir, "R_Calc_Kd_Benchmark/results/Human_Estimated_Kd.csv"))
...
# Export
#write.csv(Kd_GI_Network_DT, paste0(dir, "R_Kd_vs_GI/results/Yeast_Kd_GI.csv"))
...
#write.csv(Mean_GI_KdDeciles, paste0(dir, "R_Kd_vs_GI/results/Yeast_Mean_GI_KdDeciles.csv"))
...
#write.csv(Human_Kd_GI_Network_DF, paste0(dir, "R_Kd_vs_GI/results/Human_Kd_GI.csv"))
...
#write.csv(GIQuintile_mean, paste0(dir, "R_Kd_vs_GI/results/Human_Mean_GI_KdQuintiles.csv"))
