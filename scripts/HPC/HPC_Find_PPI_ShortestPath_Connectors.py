...
def find_PPI_SP_connectors(module_overlap_DF, 
    ...
    for pair in PPI_Module_ORFs_pairwise_comb: # For every pair of PPI modules
...
def main():
    ...
    ## Import PPI module dict
    with open((main_path+"data/PPI_module_dict.pickle"), "rb") as handle:
        PPI_module_dict = pickle.load(handle)
    
    ## Import module overlap table
    with open((main_path+"data/GI_PPI_optimal_module_overlap_clean_DF.pickle"), "rb") as handle:
        GI_PPI_optimal_module_overlap_DF = pickle.load(handle)
    ...
    ## Import network
    with open((main_path+f"data/Controls/DegPres_Randomized_PPI_Networks/random_PPI_network_{iter_num}_G.pickle"), "rb") as handle:
        PPI_network_G = pickle.load(handle)
    ...
    file_path = f"data/Controls/Random_PPI_Shortest_Path_Connectors/PPI_pairwise_module_shortest_paths_{iter_num}_dict.pickle"
