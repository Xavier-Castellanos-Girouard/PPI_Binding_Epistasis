...
# PDBbind
index_data_DF <- 
  read.csv(paste0(dir, "R_Calc_Kd_Benchmark/data/PDBbind_vs2020/INDEX_general_PP.2020.txt"),
           sep = "\t")
...
pdb_PPI_DF_list <- 
  sapply(unique(Binding_DF$ID),
         FUN = getPDB_PPI,
         PDB_dir = paste0(dir, "R_Calc_Kd_Benchmark/data/PDBbind_vs2020/PDB_files/"))
...
write.csv(pdb_PPI_Kd_DF, paste0(dir, "R_Calc_Kd_Benchmark/data/IntermediateFiles/Kd_PDB_list.csv"))
